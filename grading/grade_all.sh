#!/bin/bash
#python3 grade_lab10.py --students students.csv --workdir student_repos --report reports/lab10_report.csv --lab-path labs/lab10_recursion_and_timing
#python3 grade_lab09.py --students students.csv --workdir student_repos --report reports/lab09_report.csv --lab-path labs/lab09_inheritance_polymorphism
